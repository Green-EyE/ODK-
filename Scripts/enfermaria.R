#Reshape Ped_enf data-set by PaundeJr
...
C_T_results1 <- read_csv("~/Dashboard/excel/Pediatria_Enfermaria_PED_results.csv")
head(C_T_results1)
...
C_T_results3 <- C_T_results2 %>% rename("central_code"= "central_code" ,	"qSupLevel"= "groupNivelSupervisao:QSupLevel" ,	"supervisor"= "groupNivelSupervisao:supervisor",	"provinceCode"= "groupGeo:province",	
                       "district"= "groupGeo:district", "qGeo"= "groupGeo:QGeo", "qSupCode"="QSupCode" ,	"qGIPartner"="groupForm:groupGI:QGIPartner","Disponibilidade de material de apoio"= "groupForm:groupDS1:domainScore1",
                       "Oferta do ATS para HIV, ini­cio e continuidade do TARV"="groupForm:groupDS2:domainScore2", "Oferta do pacote de DAH"="groupForm:groupDS3:domainScore3",
                        "Rastreio de Falencia Terapeutica"="groupForm:groupDS4:domainScore4","Registo, referencia e seguimento apos a alta"="groupForm:groupDS5:domainScore5" )
head(C_T_results3)
...
#Write to disk
write.csv(C_T_results4, file = "~/Dashboard/Results/Pediatria_enfermaria.csv")                       
